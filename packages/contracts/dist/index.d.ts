export type AgentEventType = "run_started" | "tool_called" | "handoff" | "tool_failed" | "run_failed" | "run_completed" | "cost_recorded" | "human_escalation";
...
export type MarketingTaskType = "GENERATE_VIDEO" | "GENERATE_IMAGE_POST" | "GENERATE_INFOGRAPHIC" | "GENERATE_SOCIAL_POST" | "GENERATE_ARTICLE" | "TREND_COLLECT" | "TREND_ANALYZE" | "CONCEPT_GENERATE" | "CONCEPT_SCORE" | "CONCEPT_APPROVAL_REQUEST" | "CONCEPT_APPROVAL_APPLY" | "CONTENT_PLAN_GENERATE" | "CONTENT_DRAFT_GENERATE" | "CONTENT_EXECUTION_PREPARE" | "CONTENT_EXECUTE_APPROVED" | "PERFORMANCE_EVALUATE" | "LEARNING_FEEDBACK_APPLY" | "COMPLIANCE_REVIEW" | "PUBLISH_CONTENT" | "FETCH_PLATFORM_METRICS" | "ENGAGE_COMMENTS" | "ATTRIBUTION_REFRESH" | "OPTIMIZE_CONTENT_PORTFOLIO";
export type MarketingTaskStatus = "queued" | "running" | "awaiting-provider" | "retrying" | "stalled" | "completed" | "failed";
...
export type IntegrationReadinessState = "ready" | "misconfigured" | "token-expired" | "account-not-linked" | "permission-missing" | "awaiting-approval" | "unknown";
